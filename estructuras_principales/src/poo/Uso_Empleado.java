...
public class Uso_Empleado {
	...
	public static void main(String[] args) {
		...
		/*Empleado emp1 = new Empleado("Nicolas",700,2021,2,17);
		Empleado emp2 = new Empleado("Ana Lopez",800,1995,6,10);
		Empleado emp3 = new Empleado("Pedro Sanchez",500,1993,2,11);
		
		emp1.sube_sueldo(5);
		emp2.sube_sueldo(5);
		emp3.sube_sueldo(5);
		
		System.out.println("Nombre: "+emp1.dime_nombre()+" Sueldo: $"+emp1.dame_sueldo()+" Fecha de alta: "+emp1.dame_fecha_contrato());
		...
		jefe_rrhh.establece_incentivo(2570); //estableciendo incentivo
		...
		/*for(int i=0; i<3; i++)
		{
			...
			System.out.println("Nombre :"+misEmpleados[i].dime_nombre()+" Sueldo: "+misEmpleados[i].dame_sueldo()+" Fecha Alta: "+misEmpleados[i].dame_fecha_contrato());
